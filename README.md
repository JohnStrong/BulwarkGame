...
└── js/
    ...
    └── level-generators/
        ...
        ├── generate-castle-overlay-sprites.js # Castle structure overlay sprites (18 transparent-bg sprites, variable height)
